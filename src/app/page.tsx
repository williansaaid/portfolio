...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen w-full bg-light">
      <Layout className="pt-0">
        <div className="flex items-center justify-between w-full">
          <div className="w-1/2">
            <Image src={devPic} alt="Willians Jimenez" className="w-full h-auto"/>
          </div>
          <div className="w-1/2 flex flex-col items-center self-center">
            ...
            <div className="flex items-center self-start mt-2 gap-6">
              <Button href="/en-resume.pdf" text="Resume"
                download
                className="bg-dark text-light px-4 py-2 rounded-2xl text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark duration-500 ease-in-out"
              >
                <LinkArrow/>
              </Button>
              <Button
                ...
                text="Contact Me"
                className="underline bg-transparent text-dark px-6 py-2 rounded-2xl text-lg font-semibold hover:shadow-[3px_3px_8px_rgba(0,0,0,0.3)] duration-500 ease-in-out"
              />
            </div>
          </div>
        </div>
